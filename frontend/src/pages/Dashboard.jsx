...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 pt-24 px-4 pb-12">
      <div className="bg-white dark:bg-gray-900 shadow-2xl rounded-2xl p-8 max-w-6xl mx-auto">
        {/* Header */}
      ...
      {selectedInvoice && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
